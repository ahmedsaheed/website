            ...
            <Head>
                ...
                <div className="spacers gapps mx-auto max-w-3xl space-y-5">
                    ...
                    <p className="third">
                            ...
                            all the way from <Location />. Well, I'm currently working on <a target="_blank" rel="noopener" href="https://leaflet.saheed.codes"> Leaflet </a>,  a minimal distractionless markdown editor designed to quickly write, edit and navigate between multiple markdown files in a directory and its sub directories. 

...
<GoogleLogin class="top-0 right-0"
...
class Book extends Component{
  ...
  LoadMyBooks = () => {
    request.
    get("https://www.googleapis.com/books/v1/volumes/zyTCAlFPjgYC?key=AIzaSyDNMnPGw3yUzfIwUnH3PR4oMJiP-PecbhU")
    .query(null).set('Accept', 'application/json')
    .end ((error, response)=>{

...
const Dropdown = ({title,content}) => {
  ...
  return <div ref={parent}>
    ...
    { show && <center><iframe className=" fun dropdown-content" width="90%" height="992" frameborder="0" style={{backgroundColor: "white"}} src={content}></iframe></center> }
  </div>
}
...
<body>
  ...
  <header class="mx-auto max-w-3xl space-y-5"><div class="page-summary bg-am-black text-am-white mx-2 md:mx-0 p-5 " data-theme="business"> 
  <Dropdown title = "1. Bubble Sort" content="https://observablehq.com/embed/f4b54f268f34af5a?cells=viewof+codeblock%2Cintro%2Cdataset%2Cviewof+size%2Cviewof+b"/>
</div>
</header><br/>

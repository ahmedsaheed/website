...
<body>
  ...
  <header class="mx-auto max-w-3xl space-y-5"><h1 class="text-3xl font-am px-10" style = {{fontfamily: "ui-serif"}}>Selection Sort</h1><div class="page-summary bg-am-black text-am-white mx-2 md:mx-0 p-10 rounded-lg prose max-w-full" data-theme="business"><p class="first-line:uppercase first-line:tracking-widest
    ...
    <br/>
    <center><iframe width="90%" height="1166" frameborder="0" style = {{backgroundColor: "white"}}
  src="https://observablehq.com/embed/4423f3941d92eb5d?cells=intro%2Ccode%2Clastly%2Cgraph%2Cviewof+conf%2Cviewof+reset"></iframe>
</center>

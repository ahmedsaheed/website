...
export default class extends Component {
 ...
 <> 
 <NextSeo
        title="Ahmed Saheed Rambles"
        description="Some of my rambles"
        canonical="https://saheed.codes/internet/internetHome"
        openGraph={{
          url: 'https://saheed.codes/internet/internetHome',
          title: "Ahmed Saheed Rambles",
          description: 'Some of my rambles',
        }}
      />
 ...
 <title>Internet | Ahmed Saheed</title>
</head>
...
<body>
  ...
  <header class="mx-auto max-w-3xl space-y-5"><h1 class="text-3xl font-am px-10" style = {{fontfamily: "ui-serif"}}>Today I Leant 🌐</h1><div class="page-summary bg-am-black text-am-white mx-2 md:mx-0 p-10 rounded-lg prose max-w-full" data-theme="business"><p class="first-line:uppercase first-line:tracking-widest

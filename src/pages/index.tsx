        ...
        <>
            <div className="space-y-4">
                ...
                <p className="opacity-80">
                    ...
                    year old undergrad studying at Griffith College Dublin. My
                    passion lies in crafting streamlined and user-centric web
            ...
            <div className="space-y-4">
                ...
                <p className="opacity-80">
                    ...
                    as a software engineer, delving into the intricacies of
                    human computer interaction. Beyond my professional pursuits,
                    I devote the majority of my time to honing my craft in
                    software interface design and refining my skills in the art
                    of <Link href="/blog">essay writing</Link> and storytelling.
                </p>
            ...
            <div className="space-y-4">
                ...
                <p className="opacity-80">
                    In order to optimize my development process and elevate the
                    caliber of my code and projects, I employ a diverse array of
                    tools. Enclosed below, you will find a compilation of the
                    various technologies and languages with which I possess
                    prior experience or presently utilize.
                </p>
        ...
        >
            ...
            >
                <div className="flex flex-1 items-center space-x-2 text-left">
                    <span className="my-auto py-5 leading-none">
                        {project.repo}
                    </span>

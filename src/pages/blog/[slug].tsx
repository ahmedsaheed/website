...
export default function BlogPosts({ blog }: { blog: Blog[] }) {
    return(<>
        <Head>
            ...
            <p>
				<time className="prose blog" dateTime={new Date(blog.date)}>{new Date(blog.date).toDateString()}</time>
			</p>

			<main className="prose blog prose-hr:border-neutral-200 dark:prose-hr:border-neutral-800 prose-blue prose-img:rounded-md prose-img:w-full dark:prose-invert"
